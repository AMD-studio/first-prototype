...
public class TypeDestroy : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(health <= 0)
        {
            ...
            bool isAllQuestsOver = QuestManager.Instance.QuestID == data.questItems.Length - 1;

            if (QuestManager.Instance.QuestSubID == data.questItems[data.currentQuestID].objectives.Length - 1)
            {
