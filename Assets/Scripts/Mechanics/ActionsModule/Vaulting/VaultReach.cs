...
namespace Climbing
{
    public class VaultReach : VaultAction
    {
        ...
        public override bool CheckAction()
        {
            ...
            if (controller.characterInput.jump && !controller.state.isVaulting && !controller.state.isJumping && controller.state.isGrounded)
            {
        ...
        {
            if (height <= 1 || !controller.state.isVaulting)
                return;
